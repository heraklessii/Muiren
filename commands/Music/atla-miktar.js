...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('atla-miktar')
    .setDescription('İstediğiniz kadar şarkı atlarsınız.')
    .addIntegerOption(opt =>
      opt.setName('miktar')
        .setDescription('Atlamak istediğiniz şarkı miktarı.')
        .setMinValue(1)
        .setMaxValue(100)
        .setRequired(true)),
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      const success = new EmbedBuilder()
        .setColor(client.color)
        .setDescription(`☑️ | Başarıyla **${miktar}** şarkı atladım.`);
